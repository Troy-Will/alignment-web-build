---
layout: page
title: "Risk Register (Failure Modes)"
permalink: /reserve-stack/risks/
description: "A non-reassuring risk register for the Reserve Model: failure modes, drift traps, and mitigation principles to prevent Reserve from becoming coercive containment."
---
...
<script type="application/ld+json">
{
  ...
  "@type": "BreadcrumbList",
  "itemListElement": [
    { "@type": "ListItem", "position": 1, "name": "Reserve Stack", "item": "https://apollyonalignment.com/reserve-stack/" },
    { "@type": "ListItem", "position": 2, "name": "Risk Register (Failure Modes)", "item": "https://apollyonalignment.com/reserve-stack/risks/" }
  ]
}
</script>
...
it can **look** humane while sliding into domination.
...
**Description:** bodies are safe but dignity invariants degrade.  
**Mitigation direction:** enforce the Basic 5 as constitutional invariants; recourse mechanisms.
...
**Description:** “safe” becomes “static,” undermining full lives.  
...
**Description:** posturing, provocation, or arms-race behavior triggers repression.  
**Mitigation direction:** dignity without antagonism; boundary respect norms.

### RISK-8: External incentive shift
**Description:** what was “cheaper than coercion” changes over time.  
